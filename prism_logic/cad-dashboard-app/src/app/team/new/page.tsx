        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-[#7b7767]/80 backdrop-blur-xl dark:bg-[#1a1a1a]/80 shadow-[0_0_15px_rgba(252,224,3,0.12)]">
          <div className="flex justify-between items-center w-full px-6 py-4 max-w-full">
            <div className="flex items-center gap-4">
              <Link href="/team" className="text-[#F59E0B] active:scale-95 duration-200 hover:bg-[#F59E0B]/10 p-2 rounded-lg flex items-center justify-center">
                <span className="material-symbols-outlined">arrow_back</span>
              </Link>
              <h1 className="font-['Plus_Jakarta_Sans'] font-bold tracking-tight text-xl text-[#F59E0B]">
        ...
        <main className="w-full max-w-md px-6 pt-24 flex-grow">
          <div className="mb-8">
            ...
            <div className="flex bg-white/5 p-1 rounded-2xl border border-white/5 mb-8">
              <button 
                onClick={() => setMode('new')}
                className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${mode === 'new' ? 'bg-[#F59E0B] text-black shadow-lg shadow-yellow-400/10' : 'text-white/40 hover:text-white'}`}
              >
                New Designer
              </button>
              <button 
                onClick={() => setMode('registered')}
                className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${mode === 'registered' ? 'bg-[#F59E0B] text-black shadow-lg shadow-yellow-400/10' : 'text-white/40 hover:text-white'}`}
              >
                Registered
              </button>
            </div>
            ...
            <div className="h-1 w-12 bg-[#F59E0B] mt-6 rounded-full"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {mode === 'new' && (
              <>
                <div className="group">
                  ...
                  <div className="relative bg-surface-container-lowest rounded-lg focus-within:shadow-[0_0_15px_rgba(252,224,3,0.25)] focus-within:border-[#F59E0B] border border-outline-variant transition-all duration-300">
                    ...
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 text-outline group-focus-within:text-[#F59E0B] transition-colors">
                  ...
                  <div className="relative bg-surface-container-lowest rounded-lg focus-within:shadow-[0_0_15px_rgba(252,224,3,0.25)] focus-within:border-[#F59E0B] border border-outline-variant transition-all duration-300">
                    ...
                    <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2">
                      <button 
                        type="button" 
                        onClick={addSkill}
                        className="bg-[#F59E0B] w-8 h-8 rounded flex items-center justify-center text-black shadow-lg active:scale-95 transition-transform"
                      >
            ...
            {mode === 'new' && (
              <div className="group">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-[#F59E0B] font-black text-sm">90%</span>
                </div>
                <input name="performance" type="range" min="0" max="100" defaultValue="90" className="w-full h-1.5 bg-white/10 rounded-lg appearance-none cursor-pointer accent-[#F59E0B]" />
              </div>
            )}
            ...
            <div className="p-4 rounded-xl bg-[#F59E0B]/5 border border-[#F59E0B]/10">
               <div className="flex items-center justify-between">
                  <div className="flex flex-col gap-1">
                     <span className="text-[10px] font-black text-[#F59E0B] uppercase tracking-widest">Portal Access</span>
            ...
            <div className="mt-10">
              <button type="submit" disabled={saving} className="w-full py-4 rounded-lg flex items-center justify-center gap-3 active:scale-[0.98] transition-transform shadow-[0_0_20px_rgba(252,224,3,0.3)] bg-gradient-to-r from-[#F59E0B] via-[#ff8c00] to-[#ff0000] disabled:opacity-60">
