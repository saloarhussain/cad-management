  ...
  if (!hasMounted || isVerifying) {
    return (
      <div className="fixed inset-0 z-[999] bg-[#161308] flex flex-col items-center justify-center p-6 overflow-hidden">
        {/* Background Glows */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#F59E0B]/5 blur-[120px] rounded-full animate-pulse"></div>
        
        <div className="relative z-10 flex flex-col items-center">
          <div className="w-20 h-20 relative mb-8">
            <div className="absolute inset-0 border-2 border-[#F59E0B]/20 rounded-2xl rotate-45 animate-[spin_4s_linear_infinite]"></div>
            <div className="absolute inset-2 border-2 border-[#F59E0B]/40 rounded-xl -rotate-45 animate-[spin_3s_linear_infinite]"></div>
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="material-symbols-outlined text-4xl text-[#F59E0B] animate-pulse">deployed_code</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <h1 className="font-headline text-2xl font-black tracking-tighter text-white uppercase italic flex items-center gap-2">
              CADONCE <span className="text-[#F59E0B]">PRISM</span>
            </h1>
