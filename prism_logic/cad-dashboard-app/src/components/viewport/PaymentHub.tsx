    ...
    <div className="fixed top-16 bottom-20 left-0 right-0 z-[100] flex flex-col md:items-center md:justify-center md:p-4 overflow-y-auto bg-[#1e1c10] md:bg-transparent md:top-0 md:bottom-0">
      ...
      <div className="relative z-50 w-full min-h-full md:min-h-0 md:h-auto md:max-w-2xl bg-[#1e1c10] md:rounded-2xl shadow-[0_0_80px_rgba(0,0,0,0.8)] border-white/5 md:border flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="w-full md:w-2/5 bg-[#222014] p-6 flex flex-col justify-between border-r border-white/5">
          <div>
            <div className="text-[#F59E0B] font-black text-[8px] tracking-[0.3em] uppercase mb-4 opacity-70">Invoice Protocol</div>
            ...
            <div className="p-4 bg-[#2d2a1d] rounded-xl border-l-4 border-[#F59E0B] shadow-inner">
              <div className="text-neutral-500 text-[8px] font-black uppercase tracking-widest mb-1 opacity-50">Total Balance Due</div>
              <div className="text-[#F59E0B] font-headline font-black text-xl tracking-tighter">
        ...
        <div className="w-full md:w-3/5 p-8 relative bg-[#1e1c10]">
          ...
          <h3 className="text-white font-headline font-black text-sm mb-4 flex items-center gap-2 uppercase tracking-tight">
            <span className="material-symbols-outlined text-[#F59E0B] text-base">account_balance_wallet</span>
            Select Payment Method
          </h3>

          {loading ? (
            <div className="py-24 text-center">
              <span className="animate-spin material-symbols-outlined text-[#F59E0B] text-3xl">progress_activity</span>
                  ...
                  <button 
                    ...
                    className={`relative p-4 rounded-lg border text-left transition-all duration-300 group overflow-hidden ${
                      selectedMethod?.id === m.id 
                        ? 'bg-[#F59E0B] border-[#F59E0B] shadow-[0_0_20px_rgba(252,224,3,0.2)]' 
                        : 'bg-[#222014] border-white/5 hover:border-white/20'
                    }`}
                  >
                    {/* Electric Border Effect */}
                    <div className={`absolute inset-0 opacity-0 group-hover:opacity-10 pointer-events-none transition-opacity bg-gradient-to-tr from-[#F59E0B] to-[#00fbfe]`} />
          ...
          {razorpayKey && (
            <button 
              ...
              className="w-full mb-6 p-4 rounded-xl border-2 border-[#F59E0B] bg-[#F59E0B]/10 flex items-center justify-between group hover:bg-[#F59E0B] transition-all duration-300 active:scale-[0.98]"
            >
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg bg-[#F59E0B] flex items-center justify-center text-black shadow-lg">
              ...
              <span className="material-symbols-outlined text-[#F59E0B] group-hover:text-black">arrow_forward</span>
            </button>
          )}
          ...
          {selectedMethod && (
            <div className="p-6 bg-white/5 border border-white/10 rounded-2xl mb-8 animate-in slide-in-from-top-2 duration-300">
              <div className="flex justify-between items-center mb-4">
                <span className="text-[10px] font-black text-[#F59E0B] uppercase tracking-widest">{selectedMethod.type} Protocol</span>
                <button 
                  onClick={() => {
                  ...
                  className="text-[9px] font-black text-white hover:text-[#F59E0B] transition-colors uppercase tracking-widest underline decoration-dotted"
                >
                  Copy Details
                </button>
              </div>
          ...
          <div className="flex flex-col gap-2">
            <button 
              ...
              className={`w-full py-3 rounded-lg font-headline font-black text-[9px] tracking-[0.2em] uppercase transition-all duration-300 shadow-xl ${
                selectedMethod 
                  ? 'bg-gradient-to-r from-[#F59E0B] to-[#84782d] text-black hover:scale-[1.02]' 
